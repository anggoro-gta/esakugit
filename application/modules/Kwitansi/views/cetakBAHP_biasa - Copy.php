    ...
    <body onload="window.print()" style="margin:0">
        <div class="responsive">
            ...
            <table width="100%" style="font-family:arial;line-height: 2;">
                ...
                <tr>
                    <td colspan="2" align="center" style="font-size:13pt;"><b><u>BERITA ACARA HASIL PEMERIKSAAN (BAHP) <?=strtoupper($hasil['jenis_belanja'])?></u></b></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" align="justify" style="font-size:12pt;">
                        ...
                        ?>
                        Pejabat Pembuat Komitmen telah memeriksa barang-barang dengan teliti hasil pekerjaan Pengadaan <?=$hasil['jenis_belanja']?> berdasarkan <?=$dasar?> Nomor  021/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/418.54/<?=$hasil['tahun']?> tanggal <?=$tglPsn ?> dengan hasil pemeriksaan dinyatakan baik (sebagaimana terlampir) sesuai dengan Kontrak.
                    </td>
                </tr>
            </table>
            <br>
            ...
            <table width="100%" style="font-family:arial;line-height: 2; page-break-before: always;">
                <tr><td height="30px"></td></tr>
                <tr>
                    <td colspan="2" align="center" style="font-size:12pt;"><b><u>LAMPIRAN BERITA ACARA HASIL PEMERIKSAAN (BAHP) <?=strtoupper($hasil['jenis_belanja'])?></u></b></td>
                </tr>
                <tr>
