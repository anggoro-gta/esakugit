        ...
        <div class="responsive">
           ...
           <table width="100%" style="font-size:10pt;font-family:Tahoma, sans-serif;line-height: 1.2;" border="1" class="bordersolid" cellspacing="-1">
                ...
                <tbody>
                    ...
                    <?php $no=1; $totPajak=''; $pjakSblm=''; $totPph23='';?>
                        ...
                        <tr>
                            ...
                            <?php if(!empty($val->pph_21)){ ?>
                                <tr> 
                                    ...
                                    <td></td>                            
                                    <td></td>                            
                                    <td>Diterima PPh 21 atas belanja</td>
                                    <td></td>
                                    <td align="right"><?=number_format($val->pph_21,2,",",".")?></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            <?php } ?>
                            <?php if(!empty($val->pph_22)){ ?>
                                <tr> 
                                    <?php $no_nya = $no_nya+1; ?>
                                    <td align="center"><?=$no_nya?></td>  
                                    <td align="center"><?=$tgl[2].' '.$this->help->singkatanBulan($tgl[1]).' '.$tgl[0];?></td>  
                                    ...
                                    <td></td>
                                    <td align="right"><?=number_format($val->pph_22,2,",",".")?></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            <?php } ?>
                            ...
                            <?php $totPpn+=$val->ppn; $totPph21+=$val->pph_21; $totPph22+=$val->pph_22; $totPph23+=$val->pph_23; ?>
                            <?php $totPajak += ($val->ppn+$val->pph_21+$val->pph_22+$val->pph_23); $pjakSblm = $hasil->pajak_tbl_kwitansi;?>
                    ...
                    <?php if(!empty($totPph21)){ ?>
                        <tr> 
                            ...
                            <td align="center"><?=$tglR[0].' '.$this->help->singkatanBulan($tglR[1]).' '.$tglR[2];?></td>  
                            <td></td>                            
                            <td>Dibayar PPh 21 atas belanja</td>
                            <td></td>
                            <td></td>
                            <td></td>
