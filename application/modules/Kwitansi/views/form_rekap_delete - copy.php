<section class="content-header">
    <div class="content">
        <div class="col-md-12">
            <div class="judul">Hapus Rekap <?=$judul?></div>
            <h1>
...
function cari_keg(){
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo base_url().'Kwitansi/getKegiatanRekapDel'?>",
...
$("#fk_kegiatan_id").change(function(){
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo base_url().'Kwitansi/getCariRekeningBelanjaDel'?>",
        data: {tabel,fk_kegiatan_id},
        success: function(msg){
...
$("#fk_rekening_belanja_id").change(function(){
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo base_url().'Kwitansi/getCariBKU'?>",
...
function tampilkan(){  
    ...
    $.ajax({
        type:'post',
        url: "<?php echo base_url()?>Kwitansi/get_dataDeleteRekap",
