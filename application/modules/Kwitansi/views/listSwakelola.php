<section class="content-header">
    <div class="content">
        <div class="col-md-12">
            <div class="judul">Belanja Swakelola</div>
        </div>
    </div>
</section>
                    ...
                    <div class="box-content">                
                        <div class='form-horizontal' >
                            ...
                            <div class="form-group"> 
                                ...
                                <label class="col-md-1 control-label">SPJ Bulan</label>
                                <div class="col-md-2">
...
function data(){    
    ...
    kategori = 'Swakelola';
    buttonCreate = 'swakelola'
    
    $.ajax({
        type:'post',
        url: "<?php echo base_url()?>Kwitansi/getListDetail",
