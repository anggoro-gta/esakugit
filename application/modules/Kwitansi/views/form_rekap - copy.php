<section class="content-header">
    <div class="content">
        <div class="col-md-12">
            <div class="judul">Proses Rekap <?=$judul?></div>
            <h1>
...
function cari_keg(){
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo base_url().'Kwitansi/getKegiatanRekap'?>",
...
$("#fk_kegiatan_id").change(function(){
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo base_url().'Kwitansi/getCariRekeningBelanja'?>",
...
$("#fk_rekening_belanja_id").change(function(){
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo base_url().'Kwitansi/getCariDanaSblm'?>",
        data: {id_rek,bulan},
        success: function(msg){
...
function tampilkan(){  
    ...
    $.ajax({
        ...
        data:{tabel,fk_bagian_id,fk_kegiatan_id},
        beforeSend  : function(){
