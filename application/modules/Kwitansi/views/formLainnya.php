<section class="content-header">
    <div class="content">
        <div class="col-md-12">
            <div class="judul">Entri Belanja Jasa Lainnya/ Jasa Konsultansi/ Pekerjaan Kontruksi</div>
            <h1>
                        ...
                        <form class="form-horizontal" action="<?php echo base_url();?>Kwitansi/save" method="post" enctype="multipart/form-data" onsubmit="return validateForm();" id="assignmentForm">
                            <div class="col-md-6">
                                <!-- <div class="form-group required">  
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control chosen" name="jenis_belanja" id="jenis_belanja" required>
                                            <option value="">Pilih</option>
                                            <option <?=$jenis_belanja=='Barang'?'selected':''?> value="Barang">Barang</option>
                                            <option <?=$jenis_belanja=='Swakelola'?'selected':''?> value="Swakelola">Swakelola</option>
                                            <option <?=$jenis_belanja=='Jasa Lainnya/ Jasa Konsultansi/ Pekerjaan Kontruksi'?'selected':''?> value="Jasa Lainnya/ Jasa Konsultansi/ Pekerjaan Kontruksi">Jasa Lainnya/ Jasa Konsultansi/ Pekerjaan Kontruksi</option>
                                        </select>
                                    </div>
                                </div> -->
                                <input type="hidden" name="jenis_belanja" class="form-control" value="Jasa Lainnya/ Jasa Konsultansi/ Pekerjaan Kontruksi" >
                                <div class="form-group required">  
                                    <label class="col-md-3 control-label">Jenis</label>
                                    <div class="col-md-4">
                                        <select class="form-control chosen" name="sub_jenis_belanja" id="sub_jenis_belanja" required>
                                            <option value="">Pilih</option>
                                            <option <?=$sub_jenis_belanja=='Jasa Lainnya'?'selected':''?> value="Jasa Lainnya">Jasa Lainnya</option>
                                            <option <?=$sub_jenis_belanja=='Jasa Konsultansi'?'selected':''?> value="Jasa Konsultansi">Jasa Konsultansi</option>
                                            <option <?=$sub_jenis_belanja=='Pekerjaan Kontruksi'?'selected':''?> value="Pekerjaan Kontruksi">Pekerjaan Kontruksi</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="untuk_pembayaran" class="form-control" placeholder="exp : Belanja pemeliharaan printer kantor"><?=$untuk_pembayaran?></textarea>
                                    </div>
                                </div>
                               <!--  <div class="form-group">
...
$("#tgl_kesepakatan_harga").change(function(){
    tgl_pesanan = $("#tgl_pesanan").val().split("-");
    tgl_kspktan = $("#tgl_kesepakatan_harga").val().split("-");

    psn = tgl_pesanan[2]+tgl_pesanan[1]+tgl_pesanan[0];
    spkt = tgl_kspktan[2]+tgl_kspktan[1]+tgl_kspktan[0];
    
    if(spkt <= psn){
        alert('Tgl Kesepakatan Harga minimal H+1 dari Tgl Pesanan.');  
        $("#tgl_kesepakatan_harga").val('');
        $("#tgl_kesepakatan_harga").focus();     
    }
});
