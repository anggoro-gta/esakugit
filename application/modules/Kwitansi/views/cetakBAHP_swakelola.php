    ...
    <body onload="window.print()" style="margin:1">
        <div class="responsive">
            ...
            <table width="100%" style="font-family:arial;line-height: 1.6;" border="0">
                <tr>
                    <td colspan="2" align="center" style="font-size:13pt;"><b><u>BERITA ACARA PEMERIKSAAN (BAP) SWAKELOLA</u></b></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" align="justify" style="font-size:12pt;">
                        ...
                        ?>
                        Tim Pengawas telah memeriksa pekerjaan swakelola <?=$hasil['untuk_pembayaran']?> dengan teliti hasil pekerjaan swakelola berdasarkan <?=$dasar?> Nomor  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/<?=$bag->kode_bagian?>/<?=$hasil['tahun']?> tanggal <?=$tglPsn ?> dengan hasil pemeriksaan dinyatakan baik sesuai Kontrak dengan spesifikasi sebagai berikut.
                    </td>
                </tr>
                <tr><td></td></tr>
                <tr><td></td></tr>
