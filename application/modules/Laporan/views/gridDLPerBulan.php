                ...
                <div class="box-inner">
                    <div class="box-header well">
                        <div class="pull-right">
                            <form action="<?=base_url()?>Laporan/pdfDLPerBulan" method="post" class="form-horizontal" target="_blank">
                            ...
                            <table class="table table-bordered table-striped" id="example2">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="vertical-align: middle;" rowspan="2">Nama Pegawai</th>
                                                ...
                                                <?php
                                                    ...
                                                    if(isset($hasil[$val->fk_sdm_id])){
                                                        ...
                                                        foreach ($hasil[$val->fk_sdm_id] as $dtl) {
                                                            ...
                                                            if($dtl->tgl_berangkat!=$dtl->tgl_tiba && $dtl->tgl_tiba==$inya){
                                                                if($dtl->kategori=='DL'){
                                                                    echo "<div style='background-color:red;width:20px'>&nbsp;</div>";
                                                                }else{
                                                                    echo "<div style='background-color:green;width:20px'>&nbsp;</div>";
...
<script type="text/javascript">
 $("#cetakExcel").click(function(){
    ...
    nama = $("#nama").val();
    Bagian = $("#Bagian").val();
    window.location.href="<?= base_url()?>Laporan/excelPerBulan?bulan="+bulan+'&nama='+nama+'&Bagian='+Bagian;  
});
