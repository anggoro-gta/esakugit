...
<html>
    ...
    <body>
        <?php
            ...
            //'4.01.4.01.01.'. //kode lama
            $kodeKeg = $prog->kode.'.'.$keg['kode_kegiatan'].'.5.1.02.04.01.'.$kdKeg;    
            $uraian = "Belanja Perjalanan Dinas".$kat;               
            if(preg_match("/TP3/i", $keg['kegiatan'])){
                // $isTP3 = true;
                // $judul = ' TRANSPORTASI';
                // $kodeKeg = '4.01.4.01.01.21.16.5.2.2.22.01';
                // $uraian = "Belanja Transportasi";
            }
        ?>
        <div class="responsive">
            <table border="1" class="bordersolid" cellspacing="-1" width="25%" style="font-size:10px;font-family:arial;padding-top: -30px;">
                <tr>
                    <td colspan="2" width="106px">No. Kwitansi</td>
                    <td>&nbsp;<?=$hasil[0]['no_bku'].' / '.$hasil[0]['nama_bagian'].'.'.$hasil[0]['singkatan_kegiatan'].' / '.$bulan.' / '.$tahun?></td>
                </tr>
                <tr>
                    <td colspan="2">Kode Kegiatan - Rek.</td>
                    <td>&nbsp;<?=$kodeKeg?></td>
                </tr>
                <tr>
            ...
            <table width="100%" style="font-size:9pt;font-family:arial">                
                ...
                <tr>
                    <th colspan="12">BAPPEDA KABUPATEN KEDIRI TAHUN ANGGARAN <?=$tahun?></th>
                </tr>
                <tr><td colspan="12">&nbsp;</td></tr>
            </table>
            ...
            <table class="bordersolid" border="1" cellspacing="-1" width="100%" style="line-height: 1.2;font-size:9px;font-family:arial">
                ...
                <tbody>
                    <?php $pjdId=''; $no=1; $totAwal=''; $totTransport=''; $totPenginapan=''; $totSemua=''; ?>
                    <?php foreach ($hasil as $val): ?>
                    <tr>
                        <td valign="top" align="center"><?=$no++?></td>
                        <td valign="top"><?=$val['no_bku'].'/'.$val['no_bku'].'-'.$val['no_kwitansi'].'/'.$val['nama_bagian'].'.'.$val['singkatan_kegiatan'].'/'.$bulan.'/'.$tahun?></td>
            ...
            <table border="0" cellspacing="-1" width="100%" style="line-height: 1;font-size:9px;font-family:arial">
                ...
                <tr>
                    ...
                    <td align="center"><?=!empty($bendahara_pem)?'PEMBANTU':'';?></td>
                    <td></td>
                </tr>
                <?php
                    // $pa='KUASA ';
                    // if(preg_match("/KEPALA BAPPEDA/i", $kpa[0]['jabatan'])){
                    //     $pa='';
                    // }
                    $namaBndhra = $nama_bendahara;
                    $nipBndhra = $nip_bendahara;
                    if($bendahara_pem){
                        $namaBndhra = $bendahara_pem[0]['nama'];
                        $nipBndhra = $bendahara_pem[0]['nip'];
                    }
                ?>
                <tr>
                ...
                <tr>
                    <!-- <td align="center"><b><u><?=$kpa[0]['nama']?></u></b></td> -->
                    <td></td>
                    <td align="center"><b><u><?=$ptk[0]['nama']?></u></b></td>
                    <td></td>
                    <td align="center"><b><u><?=$namaBndhra?></u></b></td>
                    <td></td>
                </tr>
                <tr>
                    <!-- <td align="center">NIP. <?=$kpa[0]['nip']?></td> -->
                    <td></td>
                    <td align="center">NIP. <?=$ptk[0]['nip']?></td>
                    <td></td>
                    <td align="center">NIP.<?=$nipBndhra?> </td>
                    <td></td>
                </tr>
            </table>
        </div>
