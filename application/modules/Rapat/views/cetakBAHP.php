    ...
    <body onload="window.print()" style="margin:1">
        <div class="responsive">
            ...
            <table width="100%" style="font-family:arial;line-height: 1.6;" border="0">
                ...
                <tr>
                    <td colspan="2" align="center" style="font-size:13pt;"><b><u>BERITA ACARA PEMERIKSAAN JASA LAINNYA</u></b></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" align="justify" style="font-size:12pt;">
                        ...
                        ?>
                        Telah melaksanakan pemeriksaan terhadap Jasa Lainnya berdasarkan <?=$dasar?> Pengadaan Jasa Lainnya Nomor  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/418.54/<?=$hasil['tahun']?> tanggal <?=$tglPsn ?> dengan spesifikasi sebagai berikut:
                    </td>
                </tr>
                <tr><td></td></tr>
                <tr><td></td></tr>
