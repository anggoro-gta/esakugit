           ...
           <table width="100%" style="font-size:10pt;font-family:Tahoma, sans-serif;line-height: 1.2;" border="1" class="bordersolid" cellspacing="-1">
                ...
                <tbody>
                    ...
                    <?php foreach ($detail as $val) { ?>
                        <?php
                            $ketMakanAll = '';
                            if($val->harga_mamin > 0){
                                $ketMakan = 'mamin';
                            }
                            if($val->harga_snack > 0){
                                $ketMakan = 'snack';
                            }
                            if($val->harga_mamin > 0 && $val->harga_snack > 0){
                                $ketMakan = 'mamin dan snack';
                            }

                            if($val->harga_mamin_vip > 0){
                                $ketMakanVip = ' dan mamin VIP';
                            }
                            if($val->harga_snack_vip > 0){
                                $ketMakanVip = ' dan snack VIP';
                            }
                            if($val->harga_mamin_vip > 0 && $val->harga_snack_vip > 0){
                                $ketMakanVip = ' serta mamin VIP dan snack VIP';
                            }
                            $ketMakanAll=$ketMakan.$ketMakanVip;
                        ?>
                        <tr>
                            ...
                            <td valign="top">Belanja <?=$ketMakan.' '.strtolower($val->untuk_pembayaran)?></td>
                            <td></td>
                            <td></td>
                            ...
                            <?php if(!empty($val->pajak_daerah)){ ?>
                                <tr> 
                                    ...
                                    <td></td>                            
                                    <td></td>                            
                                    <td>Diterima Pajak Daerah atas belanja <?=$ketMakanAll?> rapat</td>
                                    <td></td>
                                    <td align="right"><?=number_format($val->pajak_daerah,2,",",".")?></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            <?php } ?>
                            <?php if(!empty($val->pph_23)){ ?>
                                <tr> 
                                    <?php $no_nya = $no_nya+1; ?>
                                    <td align="center"><?=$no_nya?></td>  
                                    <td align="center"><?=$tgl[2].' '.$this->help->singkatanBulan($tgl[1]).' '.$tgl[0];?></td>  
                                    <td></td>                            
                                    <td></td>                            
                                    <td>Diterima PPh 23 atas belanja <?=$ketMakanAll?> rapat</td>
                                    <td></td>
                                    <td align="right"><?=number_format($val->pph_23,2,",",".")?></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                            <?php } ?>

                            <?php $totPD+=$val->pajak_daerah; ?>
                            <?php if((count($detail)*3)==$no_nya){ ?>
                                <?php $no_nya = $no_nya+1; ?>
                                <tr> 
                                    <td align="center"><?=$no_nya?></td>  
                                    <td></td>                            
                                    ...
                                    <td></td>                            
                                    <td>Dibayar Pajak Daerah atas belanja <?=$ketMakanAll?> rapat</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <!-- <td align="right"><?=number_format($val->pajak_daerah,2,",",".")?></td> -->
                            ...
                            <?php $totPph23+=$val->pph_23; ?>
                            <?php if((count($detail)*3+1)==$no_nya){ ?>
                                <?php $no_nya = $no_nya+1; ?>
                                <tr> 
                                    <td align="center"><?=$no_nya?></td>  
                                    <td></td>                            
                                    <td align="center"><?=$tglR[0].' '.$this->help->singkatanBulan($tglR[1]).' '.$tglR[2];?></td> 
                                    <td></td>                            
                                    <td>Dibayar PPh 23 atas belanja <?=$ketMakanAll?> rapat</td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <!-- <td align="right"><?=number_format($val->pph_23,2,",",".")?></td> -->
                            ...
                            <?php $totPajak += ($val->pajak_daerah+$val->pph_23); $pjakSblm = $hasil->pajak_rapat;?>
