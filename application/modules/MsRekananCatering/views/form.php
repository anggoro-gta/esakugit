            ...
            <div class="box col-md-12">
                <div class="box-inner">
                    ...
                    <div class="box-content">
                        <form action="<?=base_url()?>MsRekananCatering/save" method="post" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input name="nama_pemilik" class="form-control" value="<?=$nama_pemilik?>"></input>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <textarea name="jalan" class="form-control"><?=$jalan?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Desa/Kel.</label>
                                <div class="col-md-5">
                                    <input name="desa_kel" class="form-control" value="<?=$desa_kel?>"></input>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Kecamatan</label>
                                <div class="col-md-5">
                                    <input name="kecamatan" class="form-control" value="<?=$kecamatan?>"></input>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2" align="center">
                                    <a href="<?=base_url()?>MsRekananCatering" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-chevron-left"></i> kembali</a>
