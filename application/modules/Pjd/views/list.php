<section class="content-header">
    <div class="content">
        <div class="col-md-12">
            <div class="judul">Perjalanan Dinas</div>
        </div>
    </div>
</section>
                    ...
                    <div class="box-content">                
                        <div class='form-horizontal' >
                            <div class="form-group"> 
                                <label class="col-md-2 control-label">No Surat Tugas</label>
                                <div class="col-md-3">
                                    <input type="text" id="no_surat_tugas" class="form-control kosong">
                                </div>
...
function data(){   
    ...
    $.ajax({
        type:'post',
        url: "<?php echo base_url()?>Pjd/getListDetail",
        data:{no_surat_tugas,bulan,fk_bagian_id,fk_program_id,fk_kegiatan_id,kategori},
        beforeSend  : function(){
