    ...
    <div class="content_spacer">
        <div class="content">
            <div class="box col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="table-responsive">
                    <form class="form-horizontal" action="<?php echo base_url();?>PesananBarangVer/saveVerifikasi" method="post" enctype="multipart/form-data">                     
                        <table class="table table-bordered table-striped" id="example2">
                            <thead>
                                <tr>
                                    ...
                                    <th style="vertical-align: middle;" colspan="4" class="text-center" width="25%">Verifikasi</th>
                                </tr>
                                <tr>
                                    ...
                                    <th class="text-center">Status <input type="checkbox" id="check_all"></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $no=1;?>
                                <?php foreach((array)$detail as $val) :?>
                                    <tr>
                                        ...
                                        <td><input type="text" id="qtyAkhir_<?=$val['id']?>" name="listQtyAkhir[<?=$val['id']?>]" class="form-control angka text-center"></td>
                                        <td><input type="text" name="listHargaSatBeli[<?=$val['id']?>]" class="form-control nominal text-center" onchange="cekHarga(this.value,<?=$val['id']?>)" id="harga_input_<?=$val['id']?>">
                                        </td>
                                        <td><input type="text" id="total_<?=$val['id']?>" name="listTotal" class="form-control nominal text-center" readonly></td>
                                        <td><input type="checkbox" name="listStatusVer[<?=$val['id']?>]" class="form-control text-center status_ver" id="checkbox_verifikasi_<?=$val['id']?>">
                        ...
                        <div class="form-group">
                            <div class="col-md-5">
                                <div class="form-group required">
                                    <label class="col-md-7 control-label">Tgl Verifikasi</label>
                                    <div class="col-md-5">
                                        <input type="text" name="tgl_ver" class="form-control tanggal text-center" value="<?=date('d-m-Y')?>" style="background-color: yellow" required>
                                    </div>
                                </div>                                
                            </div>
                            <div class="col-md-6">
...
function cekHarga(val,id){
    ...
    if(parseInt(repVal) > parseInt(hrgMax)){
        alert('Harga tidak boleh DIATAS Std Harga Minimal');
        // $("#checkbox_verifikasi_"+id).prop('checked',false);
        $("#harga_input_"+id).val('');
        return false;
    }
