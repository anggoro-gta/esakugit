                ...
                <div class="box-inner">
                    <div class="box-header well">
                        <div class="pull-right">
                            <a href="<?=base_url()?>MsProgramUtama/create" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-plus"></i> Tambah</a>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        var t = $("#example2").dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?= base_url()?>MsProgramUtama/getDatatables", "type": "POST"},
            columns: [
                {
                    "data": "id",
                    "orderable": false,
