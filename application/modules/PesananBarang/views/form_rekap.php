<section class="content-header">
    <div class="content">
        <div class="col-md-12">
            <div class="judul">Proses Rekap Pesanan Barang</div>
            <h1>
                        ...
                        <form class="form-horizontal" action="<?=$url?>" method="post" enctype="multipart/form-data" onsubmit="return validateForm();" id="assignmentForm"> 
                            ...
                            <div class="col-md-6">  
                                <div class="form-group required">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="no_bku" class="form-control text-center" required autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group required">
...
function cari_keg(){
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo base_url().'PesananBarang/getKegiatanRekap'?>",
        data: {fk_bagian_id},
...
$("#fk_kegiatan_id").change(function(){
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo base_url().'PesananBarang/getCariRekeningBelanja'?>",
...
function tampilkan(){  
    ...
    $.ajax({
        type:'post',
        url: "<?php echo base_url()?>PesananBarang/get_dataUpdateRekap",
        data:{fk_bagian_id,fk_kegiatan_id},
        beforeSend  : function(){
