<section class="content-header">
    <div class="content">
        <div class="col-md-12">
            <div class="judul">Proses Rekap Belanja</div>
            <h1>
                        ...
                        <form class="form-horizontal" action="<?=$url?>" method="post" enctype="multipart/form-data" onsubmit="return validateForm();" id="assignmentForm"> 
                            <div class="col-md-6">
                                <div class="form-group required">      
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="tgl_rekap" class="form-control tanggal text-center" required>
                                    </div>
                                </div>
                                <div class="form-group required">
                                    <label class="col-md-3 control-label">Kategori Rekap</label>
                                    <div class="col-md-8">
                                        <select class="form-control chosen" name="kategori_rekap" id="kategori_rekap" required>
                                            <option value="">Pilih</option>
                                            <option value="Perjadin">Perjadin</option>
                                            <option value="Lembur">Lembur</option>
                                            <option value="Rapat">Rapat</option>
                                            <option value="Honorarium">Honorarium</option>
                                            <option value="Barang_ATK">Barang ATK, Krts Cover, Bhn Komp, Perabot Kantor</option>
                                            <option value="Barang_Lainnya">Barang Lainnya</option>
                                            <option value="Jasa_Lainnya">Jasa Lainnya/ Jasa Konsultasi/ Pekerjaan Kontruksi</option>
                                            <option value="Swakelola">Swakelola</option>
                                        </select>
                                    </div>   
                                </div>
                                <div class="form-group required" id='jika_pjd'>
                                    <label class="col-md-3 control-label">Kategori PJD</label>
                                    <div class="col-md-5">
                                        <select class="form-control chosen" name="kategori_pjd" id="kategori_pjd">
                                            <option value="">.: Pilih :.</option>
                                ...
                                <div class="form-group required">      
                                    <label class="col-md-3 control-label">Rek. Belanja</label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-6">  
                               <!--  <div class="form-group required">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Pengajuan Sebelumnya</label>
                                    <div class="col-md-4">
...
$("#kategori_rekap").change(function(){
    $("#jika_pjd").hide();
    if($(this).val()=='Perjadin'){
        $("#jika_pjd").show();
    }
    cari_keg();
});
...
$("#kategori_pjd").change(function(){
    cari_keg();
});

function cari_keg(){
    kategori_rekap = $("#kategori_rekap").val();
    kategori_pjd = $("#kategori_pjd").val();
    fk_bagian_id = $("#fk_bagian_id").val();
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo base_url().'Rekap/getKegiatanRekap'?>",
        data: {kategori_rekap,kategori_pjd,fk_bagian_id},
...
$("#fk_kegiatan_id").change(function(){
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo base_url().'Rekap/getCariRekeningBelanja'?>",
        data: {fk_bagian_id,fk_kegiatan_id},
        success: function(msg){
...
$("#fk_rekening_belanja_id").change(function(){
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "<?php echo base_url().'Rekap/getCariDanaSblm'?>",
        data: {id_rek,bulan,kategori_rekap},
        success: function(msg){
...
function validateForm(assignmentForm){
    var messages = [];
    if($("#fk_bagian_id").val()==''){
        messages.push("Bagian, Tidak boleh kosong.");
    }
    if($("#fk_kegiatan_id").val()==''){
        messages.push("Sub Kegiatan, Tidak boleh kosong.");
    }
    ssaKas = $("#sisa_kas").val();
    rep_ssaKas = ssaKas.replace(/,/g,"");
    if(rep_ssaKas < 0){
        messages.push("Sisa Anggaran Tidak Boleh Minus, ");
    }
...
function tampilkan(){  
    ...
    $.ajax({
        type:'post',
        url: "<?php echo base_url()?>Rekap/get_dataUpdateRekap",
        data:{fk_bagian_id,fk_kegiatan_id,kategori_rekap,kategori_pjd,fk_rekening_belanja_id},
        // beforeSend  : function(){
