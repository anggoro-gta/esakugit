        ...
        <div class="responsive">
            ...
            <table width="100%" style="font-size:9pt;font-family:arial;margin-top:-7px" border="0">
                ...
                <tr>
                    <td>Uang Sebesar</td>
                    <td align="center">:</td>
                    <td colspan="4">Rp. <?=number_format($detail->totTarif)?></td>
                </tr>
                <tr>
                    <td valign="top">Untuk Pembayaran</td>
                    <td valign="top" align="center">:</td>
                    <td colspan="4">Uang Lembur <?=$hasil['perihal']?>, sub kegiatan <?=$hasil['kegiatan']?>, pada tanggal 
                        <?php 
                ...
                <tr>
                    ...
                    <td valign="top" align="center">:</td>
                    <td colspan="4"><b><i>(=<?=$this->help->terbilang($detail->totTarif)?> Rupiah=)</i></b>
                        <br>
                        <br>
                        <table style="line-height: 0.8;" cellspacing="-1">
                            <tr>
                                ...
                                <td>=</td>
                                <td>Rp.</td>
                                <td align="right"><?=!empty($tampilkan_pajak)?number_format($Pph23[$i]):''?></td>
                            </tr>
                        </table>
                        <br>
                    </td>
            ...
            <!-- <table width="100%" style="font-size:8pt;font-family:arial;text-align: center" border="0" cellspacing="-1" cellpadding="0">
                ...
                <tr>
                    ...
                    <td colspan="<?=$clsp?>"><b><u><?=$detail->nama_sdm?></u></b></td>
                </tr>
                <tr>
                    <?php if($hasil['nama_pejabat_kpa']){ ?>
